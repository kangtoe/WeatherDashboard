      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-baseline">
            <span className="text-4xl sm:text-5xl font-light text-gray-900 dark:text-white">{data.temperature}</span>
            <span className="text-xl text-gray-400 dark:text-gray-500 ml-1">°C</span>
          </div>
        </div>
        <div className="sm:text-right">
          <p className="text-lg font-medium text-gray-900 dark:text-white">{location.name}</p>
          <p className="text-sm text-gray-400 dark:text-gray-500">{dayStr} {timeStr}</p>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{weatherText}</p>
        </div>
      </div>
      <div className="flex flex-wrap gap-x-4 gap-y-1 mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 text-sm text-gray-500 dark:text-gray-400">
